...
namespace backend\components\crudGenerators\crud;
...
class Generator extends \yii\gii\Generator
{
    ...
    public function generateActiveField($attribute)
    {
        ...
        if ($column->name == 'status') {
            return "\$form->field(\$model, '$attribute')->dropDownList(\$model::getStatusList())";
        }
        ...
        if ($column->name == 'img') {
            return "\$form->field(\$model, '$attribute')->widget(FileAPI::className(), [
                            'settings' => [
                                'url' => ['img-upload']
                            ]
                        ])";
