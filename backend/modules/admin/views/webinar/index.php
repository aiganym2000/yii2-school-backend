...
/* @var $courseId int */
/* @var $searchModel backend\modules\admin\models\search\WebinarSearch */
...
<div class="webinar-index">
    ...
    <?php Panel::begin([
        ...
        'buttons' => [
            'create' => [
                'url' => ['/admin/webinar/create', 'courseId' => $courseId],
                'icon' => 'fa fa-plus',
                ...
                [
                    ...
                    'buttons' => [
                        'update' => function ($url, $model) {
                            $customurl = Yii::$app->getUrlManager()->createUrl(['admin/webinar/update', 'id' => $model->id]);
                        ...
                        'view' => function ($url, $model) {
                            $customurl = Yii::$app->getUrlManager()->createUrl(['admin/webinar/view', 'id' => $model->id]);
                        ...
                        'delete' => function ($url, $model) {
                            $customurl = Yii::$app->getUrlManager()->createUrl(['admin/webinar/delete', 'id' => $model->id]);
