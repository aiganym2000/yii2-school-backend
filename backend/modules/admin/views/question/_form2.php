    ...
    <div class="row">
        ...
        <?php if ($model->answer): ?>
            ...
            <?php foreach ($answer as $a): ?>
                <div class="col-md-12 form-group"><input type="text" class="form-control" placeholder="Текст ответа"
...
<script>
    ...
    function addInput() {
        var str =
            '<div class="col-md-12 form-group"><input type="text" class="form-control" placeholder="Текст ответа" name="Answer[' + x + '][text]" ></div>' +
            '<div id="input' + (x + 1) + '">';
