...
<script>
    ...
    function addInput() {
        var str =
            '<div class="col-md-12 form-group"><label for="' + x + '"><input type="text" class="form-control" placeholder="Текст ответа" name="Answer[' + x + '][text]" ></label><input type="radio" id="' + x + '" name="r" value="' + x + '"></div>' +
            '<div id="input' + (x + 1) + '">';
